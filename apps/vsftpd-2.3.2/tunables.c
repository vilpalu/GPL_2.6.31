...
tunables_load_defaults()
{
  ...
  install_str_setting("/tmp/vsftp/", &tunable_secure_chroot_dir);
  install_str_setting("ftp", &tunable_ftp_username);
  install_str_setting("root", &tunable_chown_username);
  install_str_setting("/tmp/vsftp/log/xferlog", &tunable_xferlog_file);
  install_str_setting("/tmp/vsftp/log/vsftpd.log", &tunable_vsftpd_log_file);
  install_str_setting(".message", &tunable_message_file);
  install_str_setting("nobody", &tunable_nopriv_user);
  install_str_setting(0, &tunable_ftpd_banner);
  install_str_setting("/tmp/vsftp/etc/vsftpd.banned_emails", &tunable_banned_email_file);
  install_str_setting("/tmp/vsftp/etc/vsftpd.chroot_list", &tunable_chroot_list_file);
  install_str_setting("ftp", &tunable_pam_service_name);
  install_str_setting("ftp", &tunable_guest_username);
  install_str_setting("/tmp/vsftp/etc/vsftpd.user_list", &tunable_userlist_file);
  ...
  install_str_setting("/tmp/vsftp/etc/vsftpd.email_passwords",
                      &tunable_email_password_file);
  install_str_setting("/tmp/vsftp/ssl/certs/vsftpd.pem",
