...
static struct iptables_match multiurl = { 
	.next		= NULL,
	.name		= "multiurl",
	.revision	= 0,
	.version	= IPTABLES_VERSION,
	.size		= IPT_ALIGN(sizeof(struct ipt_multiurl_info)),
	.userspacesize	= IPT_ALIGN(sizeof(struct ipt_multiurl_info)),
	.help		= &help,
	.init		= &init,
	.parse		= &parse,
