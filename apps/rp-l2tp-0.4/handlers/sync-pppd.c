...
void
sync_handler_init(EventSelector *es)
{
	...
	/* added by yangxv for more parameters, 2009.12.10 */
	PUSH_LAC_OPT("defaultroute");
	PUSH_LAC_OPT("refuse-eap");
	PUSH_LAC_OPT("usepeerdns");
	PUSH_LAC_OPT("default-asyncmap");
	PUSH_LAC_OPT("noccp");
	/* end added */
#if 0
