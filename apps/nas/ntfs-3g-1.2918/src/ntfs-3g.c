...
static void create_dev_fuse(void)
{
	...
	mknod_dev_fuse("/tmp/dev/fuse"); /* modified by gengxianhu, only tmp dir support write permission which inludes mknod */
...
#ifdef __UCLIBC__
	{
		...
		mknod_dev_fuse("/dev/misc/fuse"); /* noted by gengxianhu, currently this is useless. please go to see what "dev_fuse_msg" said */
	}
#endif
}
...
/* modified by gengxianhu for remove syslog 
#ifndef DEBUG
