...
#define DEFAULT_MODEL_URL			"http://ushare.geexbox.org/"
#define DEFAULT_MANUFACTURE			"TP-Link"
#define DEFAULT_MANUFACTURE_URL		"http://ushare.geexbox.org/"


#if (defined(BSD) || defined(__FreeBSD__))
#define DEFAULT_USHARE_IFACE      "lnc0"
#else /* Linux */
#define DEFAULT_USHARE_IFACE      "eth0.1"
#endif
