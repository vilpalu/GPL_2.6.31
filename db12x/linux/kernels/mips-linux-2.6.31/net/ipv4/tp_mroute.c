...
/* added by HouXB, 03Dec10 */
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,31))
#if CONFIG_SUPPORT_S17
			/* support db12x s17 by lyj, 26July11 */
			eth1_dev = dev_get_by_name(&init_net, "eth0.2");
#else
			eth1_dev = dev_get_by_name(&init_net, "eth1");
#endif	/* CONFIG_SUPPORT_S17 */
#else
			eth1_dev = dev_get_by_name("eth1");
#endif	
...
#if CONFIG_SUPPORT_S17
	/* support db12x s17 by lyj, 26July11 */
    eth0_dev = dev_get_by_name(&init_net, "eth0.1");
    eth1_dev = dev_get_by_name(&init_net, "eth0.2");
#else
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,31))
#if CONFIG_SUPPORT_S17
			/* support by db12x s17 by lyj, 26July11 */
			eth1_dev = dev_get_by_name(&init_net, "eth0.2");
#else
			eth1_dev = dev_get_by_name(&init_net, "eth1");
#endif	/* CONFIG_SUPPORT_S17 */
